...
//    av_log(NULL, AV_LOG_ERROR, "%02d:%02d", secs, pts);
...
//     }
    ...
    exit_program(received_nb_signals || request_cancel_exe_ffmpeg_cmd ? 255 : main_return_code);
    return received_nb_signals || request_cancel_exe_ffmpeg_cmd ? 255 : main_return_code;
}
